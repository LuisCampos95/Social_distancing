...
tracker = CentroidTracker(maxDisappeared=5, maxDistance=50)
...
def main():
    ...
    while True:
        ...
        #     fps_text = "Pessoas em risco: {}".format(max(red_zone_list))
        #     cv2.putText(frame, fps_text, (10, 320), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.8, (255, 255, 255), 1)
        # else:
        ...
        if len(red_zone_list) != 0:
            ...
            cv2.putText(frame, fps_text, (10, 380), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.8, (255, 255, 255), 1)
        else:
            fps_text = "Pessoas em risco: 0"
            cv2.putText(frame, fps_text, (10, 380), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.8, (255, 255, 255), 1)
